...
# Train with perceptron model.
from sklearn.linear_model import Perceptron
ppn_test = Perceptron(n_iter=40, eta0=0.1, random_state=0)
ppn_test.fit(data_train_std, catagory_train)
catagory_predict = ppn_test.predict(data_test_std)

# Calculate the classification accuracy.
from sklearn.metrics import accuracy_score
print('Accuracy: %.2f' % accuracy_score(catagory_test, catagory_predict))
...
plot_decision_regions(X=data_combined_std, y=catagory_combined, classifier=ppn_test, test_idx=range(105,150))
...
the three flower classes cannot be perfectly separated by a linear decision boundaries.
#
