...
#svm_test = SVC(kernel='linear', C=1.0, random_state=0)
svm_test = SVC(kernel='rbf', C=1.0, gamma=0.2, random_state=0)
svm_test.fit(data_train_std, catagory_train)
...
plot_decision_regions(X=data_combined_std, y=catagory_combined, classifier=svm_test, test_idx=range(105,150))
